  ...
  return (
    <div className="relative mx-auto max-w-screen-2xl">
      <div className="absolute top-0">
        <h1 className="text-white text-8xl font-extrabold max-w-screen-sm font-sonexFamily p-5">
